      ...
      <div className="container max-w-5xl px-4 py-12 mx-auto">
        <div className="grid gap-4 mx-4 sm:grid-cols-12">
          ...
          <div className="relative col-span-12 md:px-4 space-y-6 sm:col-span-9">
            <div className="col-span-12 space-y-12 relative md:px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-white">
              <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-[#00F0B5]">
                <h3 className="text-xl text-[#00F0B5] font-semibold tracking-wide">
                  Got awarded from BRB
                </h3>
                <time className="text-xs text tracking-wide uppercase text-slate-100">
                  Dec 2020
                </time>
                <p className="mt-3 text-slate-100 text-justify md:text-start">
