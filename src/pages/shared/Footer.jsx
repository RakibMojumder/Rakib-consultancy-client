      ...
      <footer className="px-4 divide-y text-gray-100 w-[90%] lg:w-[1100px] mx-auto">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#00F0B5]">
                <img src={logoImg} alt="" />
              </div>
              <span className="self-center text-2xl uppercase font-semibold">
                Rakib consultancy
              </span>
            </a>
          </div>
        ...
        <div className="py-6 text-sm text-center text-gray-400">
          © All rights reserved by RAKIB AHMED.
        </div>
      </footer>
    </div>
  );
