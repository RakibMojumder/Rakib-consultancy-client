...
const Stats = () => {
  return (
    <section className="p-7 my-20 md:p-8 bg-purple-50">
      <div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
        <div className="flex overflow-hidden rounded-lg bg-green-100 text-slate-800">
          <div className="flex items-center justify-center px-4 bg-[#00F0B5] text-gray-800">
            <svg
          ...
          <div className="flex items-center justify-between flex-1 p-3">
            <p className="text-lg md:text-2xl font-semibold">200+</p>
            <p>Projects</p>
          </div>
        </div>
        <div className="flex overflow-hidden rounded-lg bg-green-100 text-slate-800">
          ...
          <div className="flex items-center justify-between flex-1 p-3">
            <p className="text-lg md:text-2xl font-semibold">7 500+</p>
            <p>Customers</p>
          </div>
        </div>
        <div className="flex overflow-hidden rounded-lg bg-green-100 text-slate-800">
          ...
          <div className="flex items-center justify-between flex-1 p-3">
            <p className="text-lg md:text-2xl font-semibold">14</p>
            <p>Awards</p>
          </div>
        </div>
        <div className="flex overflow-hidden rounded-lg bg-green-100 text-slate-800">
          ...
          <div className="flex items-center justify-between flex-1 p-3">
            <p className="text-lg md:text-2xl font-semibold">5/7 Days</p>
            <p>Support</p>
          </div>
        </div>
        <div className="flex overflow-hidden rounded-lg bg-green-100 text-slate-800">
          ...
          <div className="flex items-center justify-between flex-1 p-3">
            <p className="text-lg md:text-2xl font-semibold">9</p>
            <p>Published books</p>
          </div>
        </div>
        <div className="flex overflow-hidden rounded-lg bg-green-100 text-slate-800">
